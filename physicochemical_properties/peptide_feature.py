...
from physicochemical_properties.util import nomalize_matrix
from physicochemical_properties.operator import (
...
from physicochemical_properties.amino_acid_properties import (
    AMINO_ACIDS,
    ATCHLEY_FACTOR_1,
    ATCHLEY_FACTOR_2,
    ATCHLEY_FACTOR_3,
